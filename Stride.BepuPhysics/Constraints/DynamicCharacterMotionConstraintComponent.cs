...
public class DynamicCharacterMotionConstraintComponent : TwoBodyConstraintComponent<DynamicCharacterMotionConstraint>
{
	public DynamicCharacterMotionConstraintComponent() => BepuConstraint = new();
	...
	{
		get => BepuConstraint.OffsetFromSupportToSupportPoint.ToStrideVector();
		set
		{
			BepuConstraint.OffsetFromSupportToSupportPoint = value.ToNumericVector();
			ConstraintData?.TryUpdateDescription();
		}
	}
	...
	{
		bepuConfiguration.BepuSimulations[A.SimulationIndex].Simulation.Solver.Register<DynamicCharacterMotionConstraint>();
